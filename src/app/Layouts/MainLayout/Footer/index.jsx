    ...
    <div className="w-full bg-[#252641] dark:bg-[#22262b] flex flex-col items-center justify-center gap-4 p-4 md:p-6 lg:p-8">
      <div className="w-full md:max-w-[33%] flex flex-col items-center my-5 gap-6">
        ...
        <p className="text-white text-[16px] text-center">
          ...
          و بدون نیاز به مراجعه حضوری در کل فرایند ثبت
        </p>

        <p className="text-white text-[14px] mt-3 text-center">
        ...
        <form className="w-full mx-auto">
          ...
          <div className="relative">
            <input
              type="search"
              id="default-search"
              className="block w-full p-4 text-sm text-[#607D8B] text-left rounded-full bg-white dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              placeholder="Example@gmail.com"
              required
            />
            <button
              type="submit"
              className="absolute start-2.5 bottom-2 bg-[#2196F3] text-white rounded-full font-medium text-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              خبرم کن
            </button>
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row justify-around text-center">
          ...
          <h3 className="text-white/[60%] text-[15px] border-[1px] border-x-white/[60%] border-y-transparent px-12">
            درباره ما
          </h3>
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center mb-5 p-5 rounded-lg bg-[#00000033]/[20%]">
        <div className="flex gap-3">
          ...
          <p className="text-white text-[12px]">
            تمام حقوق مادی و معنوی این مجموعه متعلق به Virtual Sprite میباشد
          </p>
        </div>
        <img
          src={icons}
          className="w-[224px] h-[32px] md:w-[160px] md:h-[24px]"
          alt="Icons"
        />
      </div>
    </div>
