...
import VerfiyCode from "./VerfiyCode.jsx"
...
const Login = ({ setContent, close }) => {
  ...
  //     </Formik>
    ...
    return(
      <div>
        {step == 1 ? (
        <StepOne step={stepCounter} setContent={setContent}  close={close} setObject={setObject}/>
      ) : step == 2 ? (
        <VerfiyCode
        
          step={stepCounter} setContent={setContent}  close={close} object={object}
