...
const CourseList1 = () => {
  ...
  const activeImageStyle =
    "h-[30px] w-[30px] rounded-full cursor-pointer bg-white";
      ...
      <div className="w-full flex">
        ...
        <div className="w-[70%]">
          <div className="w-full">
                ...
                <div className="flex justify-center my-8">
                  ...
                  {Array.from({ length: totalPages }, (_, index) => (
                    <button
                      ...
                      className={`mx-2 w-[32px] h-[32px] text-center px-3 py-1 text-[14px] rounded-full ${
                        currentPage === index + 1
            ...
            {displayComponent === "CourseRow" && (
              <CourseRow searchQuery={searchQuery} />
            )}
          </div>
        </div>
      </div>
