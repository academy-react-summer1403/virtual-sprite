...
import { MenuPanel } from "../../../components/UserPanel/MenuPanel.jsx";
import { HeaderPanel } from "../../../components/UserPanel/HeaderPanel.jsx";
import { Edit } from "../../../components/UserPanel/EditProfile/index.jsx";
import { Pishkhann } from "../../../components/UserPanel/Pishkhan/index.jsx";

const PanelLayout = () => {
  return (
    <div
      className="w-[1535px] h-[730px] m-auto bg-[#E9E7FF] flex justify-around
    ...
    >
      ...
      <div
        className="lg:w-[20%] lg:h-[95%] md:w-[20%] md:h-[95%] sm:w-[100%] sm:h-[100%] xs:w-[100%] xs:h-[100%] 
