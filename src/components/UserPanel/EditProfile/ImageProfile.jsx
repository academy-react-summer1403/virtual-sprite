...
import { SelectImg } from "../../../core/services/api/panel/EditProfile";
  ...
  const handleSubmit = async () => {
    ...
    return (
      ...
      <img></img>
        <input type="file" accept="image/*"  className="mt-[30px]"  onChange={handleFileChange}/>
        <button  className=" cursor-pointer mt-[3%] bg-[#A4F6DE] w-[70%] h-[20%] m-auto" onClick={handleSubmit}>آپلود</button>
      </div>
