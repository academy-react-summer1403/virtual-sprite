  ...
  return (
    <div
      className={`flex flex-col gap-4 p-3 rounded-md ${
        isFeatured
          ? "w-full md:w-[616px] h-[548px]"
          : "w-full md:w-[624px] h-[180px]"
      }`}
    >
      {isFeatured ? (
        <>
          ...
          <h4 className="text-[#263238] dark:text-[#f1f2f4] text-[24px] md:text-[32px] text-right truncate">
            {newsTitle}
          </h4>
          <h4 className="text-[#455A64] dark:text-[#b3b9c4] text-[14px] md:text-[16px] text-right truncate ">
            {describe}
          </h4>
        </>
      ) : (
        <div className="flex gap-2">
          <img
            src={img}
            className="w-[224px] h-[161px] rounded-2xl object-cover"
            alt={newsTitle}
          />
          <div className="flex flex-col justify-center w-full">
            <div className="flex flex-col flex-wrap text-wrap">
              <h4 className="text-[#263238] dark:text-[#f1f2f4] text-[20px] md:text-[32px] text-right text-wrap truncate">
                {newsTitle}
              </h4>
              <h4 className="text-[#455A64] w-[35rem] dark:text-[#b3b9c4] text-[12px] md:text-[16px] text-right text-wrap  truncate ">
                {describe}
              </h4>
            </div>
