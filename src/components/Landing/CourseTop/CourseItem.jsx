...
const CourseItem = ({
  ...
  return (
    <div class="flex flex-col  gap-1 bg-[#ffffff] dark:bg-[#22262b] cursor-pointer shadow-xl rounded-xl p-4 "onClick={onItemClick}
    ...
    >
      ...
      <div class="flex items-center justify-between p-2">
        <div class="text-[#263238] dark:text-[#f1f2f4] text-[16px] flex items-center gap-1">
          {" "}
          مدرس :{" "}
          <h4 class="text-[#263238] dark:text-[#f1f2f4] text-[14px]">
            {teacherName}
          </h4>
        </div>
        <h4 class="text-[#263238] dark:text-[#f1f2f4] text-[13px]">
          256 دانش‌آموز
        </h4>
      </div>
      <div class="flex items-center justify-between p-2">
        ...
        <div class="text-[#2196F3] text-[16px] flex items-center gap-1">
          {" "}
          {cost}{" "}
          <h4 class="text-[#263238] dark:text-[#f1f2f4] text-[12px]">تومان</h4>
        </div>
      </div>
    </div>
  );
